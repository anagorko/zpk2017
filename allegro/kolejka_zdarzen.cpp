...
int main(int, char**)
{
    ...
    while (true) {
        ...
        case ALLEGRO_EVENT_MOUSE_ENTER_DISPLAY: cout << "ALLEGRO_EVENT_MOUSE_BUTTON_UP"; break;
        case ALLEGRO_EVENT_MOUSE_LEAVE_DISPLAY: cout << "ALLEGRO_EVENT_MOUSE_BUTTON_UP"; break;

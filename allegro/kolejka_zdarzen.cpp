...
int main(int, char**)
{
    ...
    while (true) {
        ...
        switch (ev.type) {
        case ALLEGRO_EVENT_KEY_DOWN: cout << "ALLEGRO_EVENT_KEY_DOWN"; break;
        ...
        case ALLEGRO_EVENT_MOUSE_ENTER_DISPLAY: cout << "ALLEGRO_EVENT_MOUSE_ENTER_DISPLAY"; break;
        case ALLEGRO_EVENT_MOUSE_LEAVE_DISPLAY: cout << "ALLEGRO_EVENT_MOUSE_LEAVE_DISPLAY"; break;
